...
@Module({
  imports: [
    ...
    BullModule.registerQueue(
      ...
      BullModule.registerQueue(
        { name: QUEUE_NAMES.AI_SEO },
      BullModule.registerQueue(
        { name: QUEUE_NAMES.WORKFLOW },
      BullModule.registerQueue(
        { name: QUEUE_NAMES.PLUGIN },
      BullModule.registerQueue(
        { name: QUEUE_NAMES.ANALYTICS },
      BullModule.registerQueue(
        { name: QUEUE_NAMES.EMAIL_OTP },
    BullModule.registerQueue(
      { name: DLQ_NAMES.AI_CONTENT },
      BullModule.registerQueue(
      { name: DLQ_NAMES.AI_SEO },
      BullModule.registerQueue(
        { name: DLQ_NAMES.WORKFLOW },
      BullModule.registerQueue(
        { name: DLQ_NAMES.PLUGIN },
      BullModule.registerQueue(
        { name: DLQ_NAMES.ANALYTICS },
      BullModule.registerQueue(
        { name: DLQ_NAMES.EMAIL_OTP },
  ],
  controllers: [],
  providers: [
    QueueStatsService,
